...
// On Vercel: do not call listen() at load; attempt DB connect in background so routes can use DB after cold start
const isVercel = process.env.VERCEL === '1';
if (isVercel) {
  connectDB().catch((err) => console.error('Vercel cold start DB connect:', err.message));
}
